var app = angular.module('entertainApp');
  ...
  app.controller('musicCtrl', function($scope, albumList){
  	albumList.data().then(function(response){
  		console.log(response);
  		// console.log("hello");
  		$scope.albums = response.data.results;
  	});
  });



//THE FOLLOWING CODE WAS IN THE CONTROLLER, IT IS NOW IN THE SERVICE//
